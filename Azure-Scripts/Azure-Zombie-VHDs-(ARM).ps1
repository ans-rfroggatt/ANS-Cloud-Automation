...
If ($ModuleError) {
    Write-Output "[$(get-date -Format "dd/mm/yy hh:mm:ss")] Installing module AzureRM... <br />"
    Install-Module -Name AzureRM
    Import-Module -Name AzureRM
    Write-Output "[$(get-date -Format "dd/mm/yy hh:mm:ss")] Successfully Installed AzureRM module... <br />"
}
Import-Module -Name Azure.Storage -ErrorVariable ModuleError -ErrorAction SilentlyContinue
If ($ModuleError) {
    Write-Output "[$(get-date -Format "dd/mm/yy hh:mm:ss")] Installing module AzureStorage... <br />"
    Install-Module -Name Azure.Storage
    Import-Module -Name Azure.Storage
    Write-Output "[$(get-date -Format "dd/mm/yy hh:mm:ss")] Successfully Installed AzureStorage module... <br />"
}
...
Write-Output "[$(get-date -Format "dd/mm/yy hh:mm:ss")] Logged in to Azure Account successfully <br />"
Write-Output "<p> </p>"
