...
if(!isset($_POST["submit"]))
{
    ?>
    <div class = "github">
    <a href="https://raw.githubusercontent.com/ans-rfroggatt/ANS-Cloud-Automation/master/Azure-Scripts/Azure-Modernisation.ps1">
        <img  class="github-logo" src="/Images/GitHub.png" >
    </a>
    </div> 

    <div class="script-form" >
        <form class="script-form" name="testForm" id="testForm" action="Azure Modernisation.php" method="post" />
...
elseif((isset($_POST["submit"])) && (!empty($_POST["username"])) && (!empty($_POST["password"])) && (!empty($_POST["subid"])))
{
    ...
    $psScriptPath = "../Azure-Scripts/Azure-Modernisation.ps1";
    ...
    $log = "../Azure-Script-Logs/" . $user[0] . $subid . "-ModLog.txt";
