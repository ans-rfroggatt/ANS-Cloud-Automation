...
<div class="page-banner">
  <div class="container text-center">
    <h1>Tag VM Associated Resources</h1>      
    <p>
        Please complete the below fields to run the PowerShell script  <br />
        This script will tag the below associated resource types for each VM:  <br />
        Managed Disks  <br />
...
if(!isset($_POST["submit"]))
{
    ?>
    <div class = "github">
    <a href="https://raw.githubusercontent.com/ans-rfroggatt/ANS-Cloud-Automation/master/Azure-Scripts/Tag-VM-Associated-Resources.ps1">
        <img  class="github-logo" src="/Images/GitHub.png" >
    </a>
    </div> 

    <div class="script-form" >
        <form class="script-form" name="testForm" id="testForm" action="Tag VM Associated Resources.php" method="post" />
...
elseif((isset($_POST["submit"])) && (!empty($_POST["username"])) && (!empty($_POST["password"])) && (!empty($_POST["subid"])))
{
    ...
    $psScriptPath = "../Azure-Scripts/Tag-VM-Associated-Resources.ps1";
    ...
    $log = "../Azure-Script-Logs/" . $user[0] . $subid . "-TagLog.txt";
